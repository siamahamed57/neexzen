...
const Projects: React.FC = () => {
  ...
  const projects = [
    { id: 1, title: 'Unies E-learning Platform', category: 'PWA Application', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771708404/Screenshot_2026-02-16_at_11.06.49_PM_n4djxo.png', technologies: ['GSAP', 'PHP', 'HTML', 'CSS', 'JS', 'MySql'], description: 'Advanced E-Learning Platform with DRM, Session Management,Advanced Security Features,Login Restrictions,Quiz, Assignment,Lessions,QNA and many more features.' },
    { id: 2, title: 'Uixpertise', category: 'Wordpress Development', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771708404/Screenshot_2026-02-16_at_11.07.38_PM_v5n4hb.png', technologies: ['Wordpress', 'Custom Plugin', 'Elementor Pro', 'Custom code'], description: 'Figma to Wordpress Design,a scalable digital designer website' },
    { id: 3, title: 'Lyvaa', category: 'E-Commerce Website', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771911849/Screenshot_2026-02-16_at_11.09.54_PM_zrj1xi.png', technologies: ['Wordpress', 'Custom Plugin', 'Custom theme', 'SSL payment gateway', 'Social Login'], description: 'Advanced E-commerce website made with full complete features of e-commerce, Product add ones and live preview' },
    { id: 4, title: 'Tusqa Well Being', category: 'Mobile', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771708402/Screenshot_2026-02-16_at_11.12.05_PM_nxlfzv.png', technologies: ['React Native', 'Firebase', 'GraphQL'], description: 'Cross-platform health tracking app.' },
    { id: 5, title: 'Achol Computers', category: 'Design', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771708404/Screenshot_2026-02-16_at_11.10.39_PM_opygtr.png', technologies: ['p5.js', 'Three.js', 'WebGL'], description: 'Interactive generative art with real-time rendering.' },
    { id: 6, title: 'Being Smile', category: 'AI & ML', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771708404/Screenshot_2026-02-16_at_11.11.31_PM_lqwd4s.png', technologies: ['Python', 'WebSockets', 'Redis'], description: 'Automated trading with ML predictions.' },
  ];
