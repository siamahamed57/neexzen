...
const projects = [
  ...
  { id: 5, title: 'Achol Computers', category: 'E-commerce Store', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771708404/Screenshot_2026-02-16_at_11.10.39_PM_opygtr.png', technologies: ['p5.js', 'Three.js', 'WebGL'], description: 'Interactive generative art with real-time rendering and immersive visual experiences.', link: 'https://acholcomputers.com', tagline: 'Tech Meets Creativity' },
  { id: 6, title: 'Being Smile', category: 'Crowed Funding Website', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771708404/Screenshot_2026-02-16_at_11.11.31_PM_lqwd4s.png', technologies: ['Python', 'WebSockets', 'Redis'], description: 'Automated trading platform with ML predictions and real-time market analytics dashboard.', link: 'https://beingsmile.org', tagline: 'Smart. Fast. Reliable.' },
  { id: 7, title: 'Neexzen', category: 'Software Company', image: 'https://res.cloudinary.com/di1vdilgj/image/upload/v1771708388/Screenshot_2026-02-16_at_11.07.58_PM_ogelmn.png', technologies: ['React', 'Three.js', 'Framer Motion', 'TypeScript', 'TailwindCSS'], description: 'Our own digital studio portfolio — a high-performance, animated web experience showcasing our brand, services, and creative projects.', link: '#', tagline: 'We Build What Inspires' },
];
