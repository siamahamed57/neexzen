...
const ALL_SERVICES: ServiceItem[] = [
  // Web
  { catId: 'web', title: 'High-Conversion Landing Pages', description: 'Immersive 3D & GSAP animations that turn visitors into customers.', icon: <Globe size={16} />, features: ['Custom 3D Elements', 'GSAP Animation', 'Conversion Optimization', 'Responsive Design'], maintenance: 'Monthly Performance Checks' },
  { catId: 'web', title: 'E-commerce & Scalable Stores', description: 'Custom Shopify & WooCommerce stores with advanced plugin development.', icon: <ShoppingCart size={16} />, features: ['Shopify/WooCommerce', 'Payment Gateway', 'Inventory Management', 'Custom Themes'], maintenance: 'Security Updates & Backups' },
  { catId: 'web', title: 'Enterprise Systems (LMS/ERP/POS)', description: 'Custom internal tools to automate your workflow end-to-end.', icon: <Server size={16} />, features: ['Role-Based Access', 'Automated Workflows', 'Real-time Reporting', 'API Integration'], maintenance: 'Server Monitoring & Updates' },
  { catId: 'web', title: 'Pixel-Perfect UI/UX', description: 'Figma/Adobe XD to high-performance, responsive code.', icon: <Palette size={16} />, features: ['User Research', 'Wireframing & Prototyping', 'Design System', 'Usability Testing'], maintenance: 'Design Iterations' },
  ...
  // AI
  { catId: 'ai', title: 'Enterprise Knowledge Retrieval (RAG)', description: '"Chat with your Data" systems for secure document querying.', icon: <MessageSquare size={16} />, features: ['Vector Database', 'Semantic Search', 'Context Awareness', 'Secure Data Handling'], maintenance: 'Model Retraining' },
